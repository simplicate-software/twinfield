...
class Supplier
{
    ...
    public function addPaymentCondition(SupplierPaymentCondition $paymentCondition)
    {
        $this->paymentConditions[$paymentCondition->getID()] = $paymentCondition;
        return $this;
    }

    public function removePaymentCondition($index)
    {
        if (array_key_exists($index, $this->paymentConditions)) {
            unset($this->paymentConditions[$index]);
            return true;
        } else {
            return false;
        }
